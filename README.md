...
.
├── README.md
├── Semi-automated scan reorientation workflow.ipynb
├── requirements.txt
├── .gitignore
└── examples/
    ├── qc_contact_sheet_example.png
    └── reorientation_view_example.png
```

If you later split the notebook into scripts, a more structured layout could be:
...
│   └── Semi-automated scan reorientation workflow.ipynb
├── scripts/
│   ├── export_orientation_qc.py
│   └── manual_reorientation.py
├── examples/
├── requirements.txt
└── .gitignore
```
